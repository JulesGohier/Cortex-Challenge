...
if __name__ == '__main__':
    ...
    game_data1 = None
    game_data2 = None
    card: dict = basic_function.open_json_card("card-8") # card-8
    ...
    if game_type == "calcul":
        ...
        basic_function.calculate_time_execution(algo_calculate.algo_calculate, game_data1, game_data2, 1000)

    if game_type == "fréquence":
        print(algo_frequency.algo_frequency(game_data1))
        basic_function.calculate_time_execution(algo_frequency.algo_frequency, game_data1, game_data2, 1000)

    if game_type == "manquant":
        print(algo_missing.algo_missing(game_data1))
        basic_function.calculate_time_execution(algo_missing.algo_missing, game_data1, game_data2, 1000)

    if game_type == "labyrinthe":
        print(algo_labyrinth.algo_labyrinth(game_data1))
        basic_function.calculate_time_execution(algo_labyrinth.algo_labyrinth, game_data1, game_data2, 1000)

    if game_type == "doublon":
        print(algo_duplication.algo_duplication(game_data1))
        basic_function.calculate_time_execution(algo_duplication.algo_duplication, game_data1, game_data2, 1000)
